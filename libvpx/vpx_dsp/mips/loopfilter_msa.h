...
#define VP9_LPF_FILTER4_4W(p1_in, p0_in, q0_in, q1_in, mask, hev, p1_out, \
  ...
  {                                                                       \
    ...
    q0_out = XORI_B((v16u8)q0_m, 0x80);                                   \
    p0_m = __msa_adds_s_b(p0_m, t2);                                      \
    p0_out = XORI_B((v16u8)p0_m, 0x80);                                   \
    filt = __msa_srari_b(t1, 1);                                          \
    hev = XORI_B(hev, 0xff);                                              \
    filt &= hev;                                                          \
    q1_m = __msa_subs_s_b(q1_m, filt);                                    \
    q1_out = XORI_B((v16u8)q1_m, 0x80);                                   \
    p1_m = __msa_adds_s_b(p1_m, filt);                                    \
    p1_out = XORI_B((v16u8)p1_m, 0x80);                                   \
  }
...
#define VP9_FLAT5(p7_in, p6_in, p5_in, p4_in, p0_in, q0_in, q4_in,  \
  ...
  flat2_out = XORI_B(flat2_out, 0xff);                              \
  flat2_out &= flat_in;                                             \
}
...
#define LPF_MASK_HEV(p3_in, p2_in, p1_in, p0_in,                 \
  ...
  p1_asub_q1_m = (v16u8) SRLI_B(p1_asub_q1_m, 1);                \
